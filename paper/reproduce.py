...
TARGETS: tuple[Target, ...] = (
    Target(
        ...
        notebook="notebooks/Nelem_sweep.ipynb",
        kind="sweep",
        value="n_sweeps",
    ),
    Target(
        ...
        notebook="notebooks/element_visualization.ipynb",
        kind="sweep",
        value="n_sweeps",
    ),
    Target(
        ...
        notebook="notebooks/energy_bw_ar.ipynb",
        kind="sweep",
    ...
    Target(
        ...
        notebook="notebooks/mfs_sweep.ipynb",
        kind="sweep",
    ...
    Target(
        ...
        notebook="notebooks/aspect_ratio_scaling.ipynb",
        kind="sweep",
    ...
    Target(
        ...
        notebook="notebooks/robustness.ipynb",
        kind="script",
    ...
    Target(
        ...
        notebook="notebooks/depth_of_focus.ipynb",
        kind="script",
    ...
    Target(
        ...
        notebook="notebooks/partial_coherence.ipynb",
        kind="sweep",
    ...
    Target(
        ...
        notebook="notebooks/focal_length.ipynb",
        kind="sweep",
        value="focal_length",
    ),
    Target(
        ...
        notebook="notebooks/inter_elem_dist.ipynb",
        kind="sweep",
