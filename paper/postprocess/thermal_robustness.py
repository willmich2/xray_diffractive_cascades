...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate thermal robustness from an N_sweeps run.")
    parser.add_argument(
        "--base-id",
...
if __name__ == "__main__":
    ...
    save_path = f"{args.data_dir}/thermal_robustness_results_{args.base_id}_{save_time}.npz"
    np.savez(
        save_path,
